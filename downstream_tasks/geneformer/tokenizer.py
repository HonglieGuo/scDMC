...
Input adata:
Required format: raw counts scRNAseq adata without feature selection as .loom file
...
GENE_MEDIAN_FILE = Path(__file__).parent / "gene_median_dictionary_95m.pkl"
...
class TranscriptomeTokenizer:
    def __init__(
        ...
        """
        # dictionary of custom attributes {finetuned_models dataset column name: input .loom column name}
    ...
    def tokenize_data(
        ...
        output_directory : Path
            Path to directory where tokenized adata will be saved as .dataset
        output_prefix : str
            Prefix for finetuned_models .dataset
        file_format : str
