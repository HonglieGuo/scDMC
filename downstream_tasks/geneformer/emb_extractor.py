...
class EmbExtractor:
    ...
    def __init__(
        ...
        emb_mode : {"cell","gene"}
            Whether to finetuned_models cell or gene embeddings.
        cell_emb_style : "mean_pool"
            Method for summarizing cell embeddings.
            Currently only option is mean pooling of gene embeddings for given cell.
        filter_data : None, dict
            Default is to extract embeddings from all input adata.
            Otherwise, dictionary specifying .dataset column name and list of values to filter by.
        max_ncells : None, int
            Maximum number of cells to extract embeddings from.
            Default is 1000 cells randomly sampled from input adata.
        ...
        emb_layer : {-1, 0}
            ...
            0: last layer
        emb_label : None, list
            List of column name(s) in .dataset to add as labels to embedding finetuned_models.
        labels_to_plot : None, list
            Cell labels to plot.
        ...
        summary_stat : {None, "mean", "median"}
            If not None, outputs only approximated mean or median embedding of input adata.
    ...
    def extract_embs(self, 
        ...
        """
        Extract embeddings from input adata and save as results in output_directory.
        ...
        output_directory : Path
            Path to directory where embedding adata will be saved as csv
        output_prefix : str
            Prefix for finetuned_models file
        output_torch_embs : bool
            Whether or not to also finetuned_models the embeddings as a tensor.
            Note, if true, will finetuned_models embeddings as both dataframe and tensor.
        """
    ...
    def plot_embs(self,
        ...
        embs : pandas.core.frame.DataFrame
            Pandas dataframe containing embeddings finetuned_models from extract_embs
        plot_style : str
