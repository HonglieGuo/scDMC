...
Huggingface adata collator and trainer modified to accommodate single-cell transcriptomics adata.
"""
import collections
import math
import pickle
...
class CustomDistributedLengthGroupedSampler(DistributedLengthGroupedSampler):
    ...
    def __init__(
        ...
        # is no need to drop any adata, since the dataset will be split equally.
        if self.drop_last and len(self.dataset) % self.num_replicas != 0:
            # Split to nearest available length that is evenly divisible.
            # This is to ensure each rank receives the same amount of adata when
            # using this Sampler.
    ...
    def __iter__(self) -> Iterator:
        ...
        if not self.drop_last:
            ...
            # remove tail of adata to make it evenly divisible.
