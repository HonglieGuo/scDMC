...
# load adata and filter by defined criteria
...
class InSilicoPerturber:
    ...
    def __init__(
        ...
        emb_mode : {"cell","cell_and_gene"}
            Whether to finetuned_models impact of perturbation on cell and/or gene embeddings.
        cell_emb_style : "mean_pool"
            Method for summarizing cell embeddings.
            Currently only option is mean pooling of gene embeddings for given cell.
        filter_data : None, dict
            Default is to use all input adata for in silico perturbation study.
    ...
    def perturb_data(self, 
                     ...
                     output_prefix):
        """
        Perturb genes in input adata and save as results in output_directory.
        ...
        output_directory : Path
            Path to directory where perturbation adata will be saved as batched pickle files
        output_prefix : str
